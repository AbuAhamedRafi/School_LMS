                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Fee Structure Update</h3>
                            </div>
                            <form action="{{ route('fee_structure.update', ['id' => $fee->id]) }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <select name="academic_year_id" class="form-control" id="">
                                                ...
                                                @foreach ($academic_year as $academic_year)
                                                    <option value="{{ $academic_year->id }}"
                                                        {{ $fee->academic_year_id == $academic_year->id ? 'selected' : null }}>
                                            ...
                                            <select name="class_id" class="form-control" id="">
                                                ...
                                                @foreach ($classes as $class)
                                                    <option value="{{ $class->id }}"
                                                        {{ $fee->class_id == $class->id ? 'selected' : null }}>
                                                        {{ $class->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('class_id')
                                            ...
                                            <select name="fee_head_id" class="form-control" id="">
                                                ...
                                                @foreach ($fee_head as $fee_head)
                                                    <option value="{{ $fee_head->id }}"
                                                        {{ $fee->fee_head_id == $fee_head->id ? 'selected' : null }}>
                                        ...
                                        <div class="col">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="april" class="form-control" id="Input"
                                        ...
                                        <div class="col">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="may" class="form-control" id="Input"
                                        ...
                                        <div class="col">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="june" class="form-control" id="Input"
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="July" class="form-control"
                                                            id="Input" placeholder="Enter July Fee" value="{{old('july',$fee->july)}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="august" class="form-control"
                                                            id="Input" placeholder="Enter August Fee" value="{{old('august',$fee->august)}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="september" class="form-control"
                                                            id="Input" placeholder="Enter September Fee" value="{{old('september',$fee->september)}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="October" class="form-control"
                                                                id="Input" placeholder="Enter October Fee" value="{{old('october',$fee->october)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="november" class="form-control"
                                                                id="Input" placeholder="Enter November Fee" value="{{old('november',$fee->november)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="december" class="form-control"
                                                                id="Input" placeholder="Enter December Fee" value="{{old('december',$fee->december)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="january" class="form-control"
                                                                id="Input" placeholder="Enter January Fee" value="{{old('january',$fee->january)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="february" class="form-control"
                                                                id="Input" placeholder="Enter February Fee" value="{{old('february',$fee->february)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="march" class="form-control"
                                                                id="Input" placeholder="Enter March Fee" value="{{old('march',$fee->march)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
